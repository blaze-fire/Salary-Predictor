...
def find_jobs_from():    
    ...
    for i in range(8500,50001,30):                                                                 # to get results from other pages 
...
def save_jobs_to_excel(jobs_list):
    ...
    jobs.to_csv('/home/krish/Music/Job_ML_project/data/final.csv', mode = 'a', index = False, header = None, encoding='utf-8-sig')
